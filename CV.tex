...
\input{glyphtounicode}  % Ensure ATS-friendly PDF
...
\textbf{Wearable Technology, Human Movement, Bioelectronics, and Medical Robots.}
...
\resumeItemListStart
  \resumeItem{
    ...
    review,” \textit{Biomimetic Intelligence and Robotics}, vol. 3, no. 2, p. 100097, 2023. \\
    DOI: \href{https://doi.org/10.1016/j.birob.2023.100097}{10.1016/j.birob.2023.100097}.
  }
  \resumeItem{
    \textbf{C. Gu*} et al., “A Portable Inertial Navigation System for Total Hip Arthroplasty Targeting Direct
...
\begin{tabular}{p{16.3cm}@{\extracolsep{\fill}}r}
  ...
  \textbf{(Provincial-level) "Internet Plus" Innovation and Entrepreneurship Competition}                & Aug 2023         \\[2pt]
  \textbf{(School-level) "Internet Plus" Innovation and Entrepreneurship Competition}                    & Jul 2022         \\[2pt]
  \textbf{(School-level) Excellent Team of "Sycamore Tree" Competition}                                  & May 2022         \\[2pt]
  \textbf{(National-level) RoboMaster 2021 Mecha Master Super Competition (First Prize)}                 & Sep 2021         \\[2pt]
  \textbf{(Top 3 in the Major) "Fu Turui" Fellowship, Dept. of Biomedical Engineering}                   & Oct 2021         \\[2pt]
