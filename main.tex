...
\begin{center}
  ...
  \small
  \faMobile \hspace{.5pt} \href{tel:8613621903078}{+86 136 2190 3078}
  $|$
  \faAt \hspace{.5pt} \href{mailto:12011123@mail.sustech.edu.cn}{12011123@mail.sustech.edu.cn}
  % $|$
  ...
  $|$
  \faMapMarker \hspace{.5pt} \href{https://maps.app.goo.gl/LbpewfUA1L9HTWZ88}{Shenzhen, China}
...
\resumeSubheading {KTH Royal Institute of Technology}{Stockholm,
  ...
  in Electrical Engineering and Computer Science;   Exchange student}{Sep 2023 \textbf{--}
  Jan 2024}

\resumeSubheading {Imperial College London}{London, United Kingdom}
{Data Science Bachelor Summer School; \textbf{Grade: B-merit}}{Jun 2022 \textbf{--} Aug 2022}

\resumeSubHeadingListEnd

\section{Publicatios}
\resumeItemListStart \resumeItem{C.
  % --------------------------- Publications ---------------------------
  Gu, W.
  Lin, X.
  He, L.
  Zhang, and M.
  Zhang, “IMU-based motion capture system for rehabilitation applications: A systematic review,”
  Biomimetic Intelligence and Robotics, vol.
...
\resumeItem{Apply inertial
  technology and use inertial measurement unit to develop a motion capture system to recovery human
  motion.
} \resumeItem{Help develop Unity visualization and design the python code for signal transmission.
}
