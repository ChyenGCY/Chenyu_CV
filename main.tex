...
\resumeItem{
  ...
  Anterior Approach” (Accepted by IEEE Transactions on Instrumentation and Measurement).
}
\resumeItemListEnd
...
% ----------- Medical Robotics ----------
\resumeSubheading
{Hydraulic Tendon Driven Guidewire}{Atlanta, United States}{Project Leader in RobMed Lab}{Oct 2024 \textbf{--} Now}

\resumeItemListStart
\resumeItem{Design a hydraulic tendon driven guidewire which is non-conductive, MRI safe, and could be steerable in 3D.}
\resumeItem{Modeling the steerable guidewire static and kinematic, and conduct experiments to verify the model.}
